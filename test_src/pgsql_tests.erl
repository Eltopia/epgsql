...
netaddr_type_test() ->
    check_type(inet, "'192.168.0.1'", {192, 168, 0, 1}, [{0, 0, 0, 0}, {255,255,255,255}]),
    check_type(inet, "'2001:4f8:3:ba:2e0:81ff:fe22:d1f1'", {8193,1272,3,186,736,33279,65058,53745},
               [{0,0,0,0,0,65535,258,768}, {8193,1272,3,186,0,0,0,0}]),
    check_type(macaddr, "'08:00:2b:01:02:03'", {8, 0, 16#2b, 1, 2, 3}, [{0,0,0, 0,0,0}, {255,255,255, 255,255,255}]).
